...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mx-auto grid max-w-[1320px] items-center gap-12 px-5 py-12 lg:grid-cols-2 lg:py-20">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
              ComprometIA centraliza actas, acuerdos, responsables, evidencias y
              asistencia en una sola plataforma para monitorear el cumplimiento
              institucional en tiempo real.
            </p>
            <p className="mt-3 max-w-xl text-sm text-muted-foreground">
              Deja de perseguir acuerdos en correos, hojas de cálculo y
              documentos dispersos. Visualiza qué está pendiente, quién es
              responsable y qué evidencia respalda cada avance.
            </p>
        ...
        <div className="mx-auto max-w-[1320px] px-5 py-16 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              En muchas instituciones, las actas registran acuerdos,
              responsables y fechas. Sin embargo, el seguimiento suele hacerse
              de forma manual o dispersa, dificultando conocer el avance real,
              validar evidencias y asegurar el cumplimiento dentro de los plazos
              establecidos.
            </p>
          </div>
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                icon: Activity,
                title: "Acuerdos sin trazabilidad",
                desc: "No siempre se sabe en qué estado está cada compromiso ni quién debe actualizarlo.",
              },
              {
                icon: FileSearch,
                title: "Evidencias dispersas",
                desc: "Las pruebas de cumplimiento quedan en correos, carpetas, chats o documentos separados.",
              },
              {
                icon: ClipboardList,
                title: "Seguimiento manual",
                desc: "Los responsables deben revisar múltiples archivos para saber qué está pendiente.",
              },
              {
                icon: AlertTriangle,
                title: "Riesgo de incumplimiento",
                desc: "Los acuerdos vencidos se detectan tarde y afectan procesos de calidad, auditoría y acreditación.",
              },
            ].map((c) => (
              <article
                key={c.title}
      ...
      <section
        id="solucion"
        className="mx-auto max-w-[1320px] px-5 py-16 lg:py-20"
      >
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-display text-3xl font-bold text-primary sm:text-4xl">
            ComprometIA transforma documentos estáticos en seguimiento
            inteligente.
          </h2>
          <p className="mt-4 text-muted-foreground">
            Nuestra plataforma convierte cada acta en un sistema activo de
            gestión. Cada acuerdo tiene responsable, fecha, avance, semáforo,
            evidencias y alertas para facilitar la toma de decisiones basada en
          ...
          <div className="rounded-3xl border border-destructive/20 bg-muted/50 p-7">
            ...
            <ul className="mt-5 space-y-3">
              {[
                ...
                "Evidencias difíciles de encontrar",
                "Seguimiento tardío",
              ].map((t) => (
                <li
                  key={t}
          ...
          <div className="rounded-3xl border border-accent/30 bg-gradient-to-br from-card to-secondary/40 p-7 shadow-card">
            ...
            <ul className="mt-5 space-y-3">
              {[
                ...
                "Alertas y dashboard en tiempo real",
              ].map((t) => (
                <li
                  key={t}
            ...
            {[
              {
                ...
                icon: ClipboardList,
                title: "Crear el acta",
                desc: "Registra reunión interna o externa, proceso, fecha, unidad orgánica, agenda, desarrollo y anexos.",
              },
              {
                n: "2",
                icon: Users,
                title: "Registrar acuerdos",
                desc: "Cada acuerdo incluye responsable, fecha de inicio, fecha máxima, estado y porcentaje de avance.",
              },
              {
                n: "3",
                icon: CloudUpload,
                title: "Subir evidencias",
                desc: "Adjunta documentos, fotos, videos, grabaciones o actas físicas escaneadas.",
              },
              {
                n: "4",
                icon: Gauge,
                title: "Monitorear cumplimiento",
                desc: "Visualiza dashboard, semáforos, alertas, inasistencias y cumplimiento por área.",
              },
            ].map((s) => (
              <div
                key={s.n}
          ...
          {[
            {
              icon: Crown,
              role: "SuperAdmin",
              sub: "Jefe del área de calidad",
              items: [
                "Revisa todas las actas",
                "Visualiza indicadores generales",
                "Asigna admins a usuarios",
                "Supervisa cumplimiento institucional",
              ],
            },
            {
              icon: UserCog,
              role: "Admin",
              sub: "Responsable de área",
              items: [
                "Revisa actas por área",
                "Asigna convocadores",
                "Supervisa acuerdos de su área",
                "Valida evidencias e inasistencias",
              ],
            },
            {
              icon: Megaphone,
              role: "Convocador",
              sub: "Responsable de crear la reunión",
              items: [
                "Convoca reuniones",
                "Crea actas",
                "Registra acuerdos",
                "Asocia responsables y asistentes",
              ],
            },
            {
              icon: UserCheck,
              role: "Asistente",
              sub: "Miembro de la comunidad académica",
              items: [
                "Registra asistencia",
                "Consulta acuerdos asignados",
                "Revisa calendario personal",
                "Firma virtualmente su participación",
              ],
            },
          ].map((r) => (
            <article
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-2">
            ...
            <div>
              <h3 className="mb-4 flex items-center gap-2 font-display text-xl font-bold text-primary">
                <LayoutDashboard className="size-5 text-accent" /> Web /
                Intranet
              </h3>
                ...
                {[
                  {
                    icon: ClipboardList,
                    title: "Crear acta",
                    desc: "Formato estándar y asistencia de IA simulada.",
                  },
                  {
                    icon: FileText,
                    title: "Acta y acuerdos",
                    desc: "Lista de acuerdos con responsable principal.",
                  },
                  {
                    icon: Gauge,
                    title: "Seguimiento de acuerdos",
                    desc: "Fecha inicio/fin, semáforo, porcentaje de avance y evidencias.",
                  },
                  {
                    icon: Video,
                    title: "Evidencias de reunión",
                    desc: "URL de grabación, fotos, videos, documentos y acta física.",
                  },
                  {
                    icon: SignalHigh,
                    title: "Semáforo de áreas",
                    desc: "Verde: asisten, amarillo: cumplen, rojo: no cumplen.",
                  },
                  {
                    icon: LayoutDashboard,
                    title: "Dashboard general",
                    desc: "Indicadores por acta, acuerdo, responsable y área.",
                  },
                ].map((c, idx, arr) => (
                  <div key={c.title}>
                    ...
                    {[
                      {
                        icon: QrCode,
                        title: "QR del acta",
                        desc: "Escaneo para ver acta y registrar asistencia.",
                      },
                      {
                        icon: Fingerprint,
                        title: "Firma virtual",
                        desc: "Asistencia con reconocimiento facial simulado.",
                      },
                      {
                        icon: CalendarDays,
                        title: "Calendario personal",
                        desc: "Acuerdos por usuario con fechas y recordatorios.",
                      },
                    ].map((c) => (
                      <div
                        key={c.title}
      ...
      >
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            ComprometIA permite identificar rápidamente qué áreas avanzan, qué
            acuerdos están en riesgo y qué evidencias faltan para cerrar
            compromisos.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:content-start">
            {[
              ...
              {
                v: "9",
                l: "Evidencias pendientes",
                t: "text-[oklch(0.70_0.18_45)]",
              },
            ].map((k) => (
              <div
                key={k.l}
              ...
              >
                <p className={`font-display text-3xl font-extrabold ${k.t}`}>
                  {k.v}
                </p>
      ...
      <section className="mx-auto max-w-[1320px] px-5 py-20">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-[oklch(0.28_0.11_262)] p-10 text-center text-primary-foreground shadow-soft lg:p-16">
          ...
          <div className="relative">
            <LogoIso
              size="xl"
              className="mx-auto mb-5 rounded-2xl bg-primary-foreground/95 p-2"
            />
            ...
            <p className="mx-auto mt-4 max-w-2xl text-primary-foreground/90">
              Con ComprometIA, las instituciones pueden monitorear compromisos,
              validar evidencias y fortalecer procesos de calidad, auditoría y
              acreditación.
            </p>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            >
              ...
              <p
                className={`mt-2 font-display text-2xl font-extrabold ${c.tone}`}
              >
                {c.value}
              </p>
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-[auto_1fr]">
          <div className="flex flex-col items-center justify-center rounded-2xl border border-border bg-background p-4">
            <div
              ...
              style={{
                background:
                  "conic-gradient(var(--color-success) 274deg, var(--color-secondary) 0)",
              }}
            >
          ...
          <div className="rounded-2xl border border-border bg-background p-4">
            ...
            {[
              {
                t: "Actualizar matriz de seguimiento",
                s: "amarillo" as const,
                e: "En proceso",
              },
              {
                t: "Subir evidencia de acreditación",
                s: "verde" as const,
                e: "Cumplido",
              },
              {
                t: "Validar asistencia por área",
                s: "rojo" as const,
                e: "Vencido",
              },
            ].map((r) => (
              <div
                key={r.t}
                className="flex items-center justify-between gap-2 border-t border-border/60 py-2 first:border-t-0"
              >
    ...
    <div className="rounded-3xl border border-border bg-card p-6 shadow-soft">
      <div className="grid gap-6 sm:grid-cols-2">
        <div className="flex flex-col items-center justify-center">
          <p className="mb-3 self-start text-sm font-semibold text-primary">
            Avance general
          </p>
          <div
            className="grid size-36 place-items-center rounded-full"
            style={{
              background: `conic-gradient(var(--color-success) ${ring * 3.6}deg, var(--color-secondary) 0)`,
            }}
          >
        ...
        <div>
          ...
          <div className="flex h-36 items-end gap-3">
            {[
              ...
              >
                <div
                  className={`w-full rounded-t-lg ${b.c}`}
                  style={{ height: b.h }}
                />
